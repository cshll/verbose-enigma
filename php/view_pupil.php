...
$stmt = $pdo->prepare("SELECT pupils.* FROM pupils WHERE pupil_id = :pupil_id");
$stmt->execute(['pupil_id' => $_GET['id']]);
    ...
    <div class="app-container">
      ...
      <?php if ($_SESSION['usertype'] == 'admin'): ?>
        <section class="card-container">
          ...
          <a class="btn btn-primary-grad" href="delete_pupil.php?id=<?php echo $pupil['pupil_id']; ?>" onclick="return confirm('Are you sure you want to delete this pupil? This cannot be undone.')">Delete Pupil</a>
        </section>
      <?php endif; ?>
